    ...
    <>
      ...
      <section className="page-hero">
        <div className="container">
          <p className="crumb"><a href="/">Home</a> / PMS Licensing</p>
          <h1>💼 Portfolio Management Services (PMS)</h1>
          <p>Managing money for others — formally, legally and profitably. We get you the SEBI badge and keep it shiny.</p>
        </div>
      </section>
      ...
      <section>
        <div className="container two-col">
          <div className="block">
            ...
            <p>A PMS is a licence to manage other people&apos;s money stock-by-stock, account-by-account. SEBI guards this door carefully.</p>
            <div className="analogy">
              👨‍🍳 <b>Toddler version:</b> A mutual fund is a big shared lunchbox; everyone gets the same meal. A PMS is your <em>own personal chef</em> who cooks only for you — but the chef needs a licence from the food police (SEBI) before cooking.
            </div>
            <div className="factbox">
              <ul>
                <li><b>💰 Net worth:</b> the portfolio manager must hold a minimum net worth of ₹5 crore <em>at all times</em>.</li>
                <li><b>🎟️ Minimum ticket per client:</b> ₹50 lakh — PMS is for serious money.</li>
                <li><b>🔁 Registration renewal:</b> every 3 years — we calendar it so it never sneaks up.</li>
                <li><b>👤 Accredited investor route:</b> accredited clients can unlock product flexibility; we map the accreditation framework for you.</li>
              </ul>
            </div>
          </div>
          <div>
            <div className="factbox" style={{ marginBottom: "26px" }}>
              <h3>🪜 How We Help</h3>
              <ul>
                <li><b>Licence:</b> SEBI PMS application, fit-and-proper prep, net worth planning.</li>
                <li><b>Systems:</b> audit trails, risk systems, back-office and custodian setup.</li>
                <li><b>Documents:</b> investment agreements, disclosure documents, client onboarding packs.</li>
                <li><b>After launch:</b> periodic reporting, audits, renewals, new-product filings.</li>
              </ul>
            </div>
            <div className="factbox">
              <h3>❓ Quick FAQs</h3>
              <ul>
                <li><b>PMS vs AIF?</b> PMS = separate account per client. AIF = one pooled fund. Different licences, different rules.</li>
                <li><b>Can a PMS accept offshore money?</b> Within limits under FEMA — we structure it properly.</li>
              </ul>
            </div>
          </div>
        </div>
